...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authSerivce = createFargateService("AuthService",
                "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "pR30N8JLWaK1sQWsoaayeBNlE8vapCv1"));

        authSerivce.getNode().addDependency(authDbHealthCheck);
        authSerivce.getNode().addDependency(authServiceDb);
    ...
    private FargateService createFargateService(String id,
        ...
        if (db != null) {
            ...
            envVars.put("SPRING_DATABASE_USERNAME", "admin_user");
            envVars.put("SPRING_DATABASE_PASSWORD", db.getSecret().secretValueFromJson("password").toString());
